...
export default function TermsAndConditionsPage() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 py-8 px-4" dir={isRTL ? 'rtl' : 'ltr'}>
            <div className="max-w-4xl mx-auto space-y-6" dir={isRTL ? 'rtl' : 'ltr'}>
                ...
                {/* Content */}
                <div className="space-y-8 text-base text-gray-800 dark:text-gray-200 leading-relaxed" dir={isRTL ? 'rtl' : 'ltr'}>
                    {locale === 'ar' ? (
                        <>
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">1. المقدمة</h2>
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">2. التعاريف</h2>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">3. نطاق الخدمات</h2>
                                <p className="mb-2" dir="rtl">توفر المنصة الخدمات الرقمية التالية:</p>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">4. الحساب الشخصي للمستخدم</h2>
                                <h3 className="text-xl font-medium mb-2" dir="rtl">4.1 دقة المعلومات</h3>
                                <p className="mb-4" dir="rtl">
                                    يجب على المستخدم تقديم معلومات صحيحة وكاملة عند إنشاء الحساب أو حجز أي خدمة.
                                </p>
                                <h3 className="text-xl font-medium mb-2" dir="rtl">4.2 أمان الحساب</h3>
                                <p className="mb-4" dir="rtl">
                                    المستخدم مسؤول عن الحفاظ على سرية بيانات الدخول الخاصة به، وعن أي نشاط يتم من خلال حسابه.
                                </p>
                                <h3 className="text-xl font-medium mb-2" dir="rtl">4.3 سوء الاستخدام</h3>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">5. المواعيد وإعادة الجدولة والإلغاء</h2>
                                <h3 className="text-xl font-medium mb-2" dir="rtl">5.1 الحجز</h3>
                                <p className="mb-4" dir="rtl">
                                    يمكن للمستخدمين حجز المواعيد وفقًا للأوقات المتاحة المعروضة على المنصة.
                                </p>
                                <h3 className="text-xl font-medium mb-2" dir="rtl">5.2 إعادة الجدولة</h3>
                                <p className="mb-4" dir="rtl">
                                ...
                                <h3 className="text-xl font-medium mb-2" dir="rtl">5.3 الإلغاء</h3>
                                <p className="mb-4" dir="rtl">
                                ...
                                <h3 className="text-xl font-medium mb-2" dir="rtl">5.4 عدم الحضور</h3>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">6. خدمات المختبر</h2>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">7. المدفوعات</h2>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">8. الخصوصية وحماية البيانات</h2>
                                <h3 className="text-xl font-medium mb-2" dir="rtl">8.1 جمع البيانات</h3>
                                <p className="mb-4" dir="rtl">
                                    نجمع المعلومات اللازمة لإنشاء الحسابات وإدارة الحجوزات وتقديم الخدمات.
                                </p>
                                <h3 className="text-xl font-medium mb-2" dir="rtl">8.2 استخدام البيانات</h3>
                                <p className="mb-4" dir="rtl">
                                    قد تُستخدم المعلومات لتأكيد المواعيد، ومشاركة نتائج المختبر على حساب المستخدم، وإرسال الإشعارات، وتحسين أداء المنصة.
                                </p>
                                <h3 className="text-xl font-medium mb-2" dir="rtl">8.3 مشاركة البيانات</h3>
                                <p className="mb-4" dir="rtl">
                                ...
                                <h3 className="text-xl font-medium mb-2" dir="rtl">8.4 الأمان</h3>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">9. مسؤوليات المستخدم</h2>
                                <p className="mb-2" dir="rtl">يوافق المستخدم على:</p>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">10. قيود المنصة</h2>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">11. التعديلات</h2>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">12. تحديد المسؤولية</h2>
                                <p className="mb-2" dir="rtl">بأقصى حد يسمح به القانون:</p>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">13. القانون والاختصاص القضائي</h2>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">14. الاتصال</h2>
                                <p className="mb-4" dir="rtl">
                        ...
                        <>
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">1. {t('terms_introduction') || 'Introduction'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">2. {t('terms_definitions') || 'Definitions'}</h2>
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">3. {t('terms_scope') || 'Scope of Services'}</h2>
                                <p className="mb-2">{t('terms_platform_facilitates') || 'The Platform facilitates:'}</p>
                                <ul className="list-disc list-inside space-y-2 ms-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">4. {t('terms_user_account') || 'User Account'}</h2>
                                <h3 className="text-xl font-medium mb-2">4.1 {t('terms_info_accuracy') || 'Information Accuracy'}</h3>
                                <p className="mb-4">
                                ...
                                <h3 className="text-xl font-medium mb-2">4.2 {t('terms_security') || 'Security'}</h3>
                                <p className="mb-4">
                                ...
                                <h3 className="text-xl font-medium mb-2">4.3 {t('terms_misuse') || 'Misuse'}</h3>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">5. {t('terms_appointments') || 'Appointments, Rescheduling, and Cancellation'}</h2>
                                <h3 className="text-xl font-medium mb-2">5.1 {t('terms_booking') || 'Booking'}</h3>
                                <p className="mb-4">
                                    {t('terms_booking_text') || 'Users may book appointments based on available time slots shown on the Platform.'}
                                </p>
                                <h3 className="text-xl font-medium mb-2">5.2 {t('terms_rescheduling') || 'Rescheduling'}</h3>
                                <p className="mb-4">
                                ...
                                <h3 className="text-xl font-medium mb-2">5.3 {t('terms_cancellation') || 'Cancellation'}</h3>
                                <p className="mb-4">
                                ...
                                <h3 className="text-xl font-medium mb-2">5.4 {t('terms_no_show') || 'No-Show'}</h3>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">6. {t('terms_lab_services') || 'Laboratory Services'}</h2>
                                <ul className="list-disc list-inside space-y-2 ms-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">7. {t('terms_payments') || 'Payments'}</h2>
                                <ul className="list-disc list-inside space-y-2 ms-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">8. {t('terms_privacy') || 'Privacy & Data Protection'}</h2>
                                <h3 className="text-xl font-medium mb-2">8.1 {t('terms_data_collection') || 'Data Collection'}</h3>
                                <p className="mb-4">
                                ...
                                <h3 className="text-xl font-medium mb-2">8.2 {t('terms_data_use') || 'Data Use'}</h3>
                                <p className="mb-4">
                                ...
                                <h3 className="text-xl font-medium mb-2">8.3 {t('terms_data_sharing') || 'Data Sharing'}</h3>
                                <p className="mb-4">
                                ...
                                <h3 className="text-xl font-medium mb-2">8.4 {t('terms_security_measures') || 'Security'}</h3>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">9. {t('terms_user_responsibilities') || 'User Responsibilities'}</h2>
                                <p className="mb-2">{t('terms_users_agree') || 'Users agree to:'}</p>
                                <ul className="list-disc list-inside space-y-2 ms-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">10. {t('terms_limitations') || 'Platform Limitations'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">11. {t('terms_modifications') || 'Modifications'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">12. {t('terms_liability') || 'Limitation of Liability'}</h2>
                                <p className="mb-2">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">13. {t('terms_governing_law') || 'Governing Law & Jurisdiction'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">14. {t('terms_contact') || 'Contact'}</h2>
                                <p className="mb-4">
