                            ...
                            return (
                              ...
                              >
                                <div className={`flex items-center gap-4 w-full sm:w-auto min-w-0 ${isRTL ? 'sm:justify-end' : ''}`} dir={isRTL ? 'rtl' : 'ltr'}>
                                  ...
                                  >
                                    <h4 className="font-medium text-gray-900 dark:text-white" style={isRTL ? { textAlign: 'right', direction: 'rtl' } : { textAlign: 'left', direction: 'ltr' }} dir={isRTL ? 'rtl' : 'ltr'}>
                                      {patientName}
                                    </h4>
                                    <div
                                    ...
                                    >
                                      <span className={`flex items-center gap-1 ${isRTL ? 'flex-row-reverse justify-end' : ''}`} dir={isRTL ? 'rtl' : 'ltr'} style={isRTL ? { direction: 'rtl', textAlign: 'right' } : { textAlign: 'left' }}>
                                      ...
                                      {patient.age && (
                                        <span dir={isRTL ? 'rtl' : 'ltr'} style={isRTL ? { textAlign: 'right', direction: 'rtl' } : { textAlign: 'left' }}>{locale === 'ar' ? toArabicNumerals(patient.age.toString()) : patient.age} {t('years_old') || 'years old'}</span>
                                      )}
                                    </div>
                                    <div
                                  ...
                                  {appointment.status === 'completed' ? t('dd_status_completed') :
                                    appointment.status === 'scheduled' ? t('dd_status_scheduled') :
                                      appointment.status === 'confirmed' ? t('dd_status_confirmed') :
                                        appointment.status === 'cancelled' ? t('dd_status_cancelled') || 'Cancelled' :
                                          appointment.status}
                                </Badge>
                              </div>
                              {appointment.symptoms && (
