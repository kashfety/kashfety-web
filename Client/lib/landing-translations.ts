...
const arTranslations = {
  ...
  about: {
    ...
    description:
      'نحن نؤمن بأن الرعاية الصحية يجب أن تكون بسيطة وشفافة وميسورة الوصول. تربطك كشفيتي بشبكة معتمدة من الأطباء ومراكز التشخيص، مما يضع صحتك تحت السيطرة.',
    values: [
  ...
  footer: {
    ...
    terms: 'شروط الخدمة',
    copyright: '© 2024 كشفيتي. جميع الحقوق محفوظة.',
  },
} as const
