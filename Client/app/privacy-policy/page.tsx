                ...
                <div className="space-y-8 text-base text-gray-800 dark:text-gray-200 leading-relaxed" dir={isRTL ? 'rtl' : 'ltr'}>
                    {locale === 'ar' ? (
                        <>
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">2. المعلومات التي نقوم بجمعها</h2>
                                <p className="mb-4" dir="rtl">
                                    قد نقوم بجمع الأنواع التالية من المعلومات:
                                </p>

                                <h3 className="text-xl font-medium mb-2" dir="rtl">2.1 المعلومات الشخصية</h3>
                                ...
                                <h3 className="text-xl font-medium mb-2 mt-4" dir="rtl">2.2 المعلومات الطبية والصحية</h3>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                                ...
                                <h3 className="text-xl font-medium mb-2 mt-4" dir="rtl">2.3 المعلومات التقنية</h3>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">3. كيفية استخدام المعلومات</h2>
                                <p className="mb-2" dir="rtl">قد تُستخدم المعلومات لتلبية أغراض مثل:</p>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                                ...
                                <p className="mt-4 font-medium" dir="rtl">
                                    لا تُستخدم المعلومات الطبية للإعلانات أو أي أغراض خارج نطاق الخدمة.
                                </p>
                            </section>

                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">4. مشاركة المعلومات</h2>
                                <p className="mb-4" dir="rtl">
                                    قد تُشارك المعلومات فقط مع:
                                </p>

                                <h3 className="text-xl font-medium mb-2" dir="rtl">4.1 مقدمي الرعاية الطبية</h3>
                                <p className="mb-4" dir="rtl">
                                    الأطباء والعيادات المرتبطون بمواعيد المستخدم.
                                </p>

                                <h3 className="text-xl font-medium mb-2" dir="rtl">4.2 المختبرات</h3>
                                <p className="mb-4" dir="rtl">
                                    المختبرات التي تقوم بإجراء الفحوصات وتحميل النتائج على حساب المستخدم.
                                </p>

                                <h3 className="text-xl font-medium mb-2" dir="rtl">4.3 مقدمو الخدمات</h3>
                                <p className="mb-4" dir="rtl">
                                ...
                                <h3 className="text-xl font-medium mb-2" dir="rtl">4.4 الالتزام القانوني</h3>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">5. تخزين البيانات وأمانها</h2>
                                <ul className="list-disc space-y-2 list-inside ms-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">6. حقوق المستخدمين</h2>
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">7. مدة الاحتفاظ بالبيانات</h2>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">8. خصوصية الأطفال</h2>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">9. الكوكيز والتقنيات المشابهة</h2>
                                <p className="mb-2" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">10. التغييرات على سياسة الخصوصية</h2>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">11. القانون والاختصاص القضائي</h2>
                                <p className="mb-4" dir="rtl">
                            ...
                            <section dir="rtl">
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white" dir="rtl">12. الاتصال</h2>
                                <p className="mb-4" dir="rtl">
                        ...
                        <>
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">1. {t('privacy_introduction') || 'Introduction'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">2. {t('privacy_information_collected') || 'Information We Collect'}</h2>
                                <p className="mb-4">
                                    {t('privacy_collect_intro') || 'We may collect the following types of information:'}
                                </p>

                                <h3 className="text-xl font-medium mb-2">2.1 {t('privacy_personal_info') || 'Personal Information'}</h3>
                                ...
                                <h3 className="text-xl font-medium mb-2 mt-4">2.2 {t('privacy_medical_info') || 'Medical & Health-Related Information'}</h3>
                                <ul className="list-disc list-inside space-y-2 ms-4">
                                ...
                                <h3 className="text-xl font-medium mb-2 mt-4">2.3 {t('privacy_technical_info') || 'Technical Information'}</h3>
                                <ul className="list-disc list-inside space-y-2 ms-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">3. {t('privacy_how_we_use') || 'How We Use Your Information'}</h2>
                                <p className="mb-2">{t('privacy_use_intro') || 'Your information may be used to:'}</p>
                                <ul className="list-disc list-inside space-y-2 ms-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">4. {t('privacy_sharing') || 'Sharing Your Information'}</h2>
                                <p className="mb-4">
                                    {t('privacy_sharing_intro') || 'We may share your information only with:'}
                                </p>

                                <h3 className="text-xl font-medium mb-2">4.1 {t('privacy_medical_providers') || 'Medical Providers'}</h3>
                                <p className="mb-4">
                                    {t('privacy_providers_text') || 'Doctors and clinics involved in your medical appointments.'}
                                </p>

                                <h3 className="text-xl font-medium mb-2">4.2 {t('privacy_laboratories') || 'Laboratories'}</h3>
                                <p className="mb-4">
                                    {t('privacy_labs_text') || 'Labs performing your requested tests and uploading results.'}
                                </p>

                                <h3 className="text-xl font-medium mb-2">4.3 {t('privacy_service_providers') || 'Service Providers'}</h3>
                                <p className="mb-4">
                                ...
                                <h3 className="text-xl font-medium mb-2">4.4 {t('privacy_legal_requirements') || 'Legal Requirements'}</h3>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">5. {t('privacy_storage_security') || 'Data Storage & Security'}</h2>
                                <ul className="list-disc list-inside space-y-2 ms-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">6. {t('privacy_user_rights') || 'User Rights'}</h2>
                                <p className="mb-2">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">7. {t('privacy_retention') || 'Data Retention'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">8. {t('privacy_children') || 'Children\'s Privacy'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">9. {t('privacy_cookies') || 'Cookies & Tracking Technologies'}</h2>
                                <p className="mb-2">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">10. {t('privacy_changes') || 'Changes to This Privacy Policy'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">11. {t('privacy_jurisdiction') || 'Jurisdiction'}</h2>
                                <p className="mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">12. {t('privacy_contact') || 'Contact Us'}</h2>
                                <p className="mb-4">
