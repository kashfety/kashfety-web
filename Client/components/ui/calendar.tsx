    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          // Default available day: solid black text for visibility
          "h-9 w-9 p-0 font-medium text-black aria-selected:opacity-100"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-emerald-600 text-white hover:bg-emerald-700 hover:text-white focus:bg-emerald-700 focus:text-white",
  day_today: "ring-1 ring-emerald-500 text-black",
        day_outside:
