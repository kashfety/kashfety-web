...
function LocaleToggle() {
  ...
  return (
    <button
      ...
      className="p-1.5 sm:p-2 hover:bg-gray-100 dark:hover:bg-[#1F1F23] rounded-lg transition-colors text-sm font-medium text-gray-700 dark:text-gray-300"
    >
...
// Top Navigation Component - Replaced with Profile Header
function ProfileHeader({ doctorProfile }: { doctorProfile: DoctorProfile | null }) {
  ...
  return (
    <div className="px-3 sm:px-6 flex items-center justify-end gap-2 sm:gap-4 bg-white dark:bg-[#0F0F12] border-b border-gray-200 dark:border-[#1F1F23] h-full">
      <ThemeToggle />
      <LocaleToggle />
      ...
      <DropdownMenu>
        <DropdownMenuTrigger className="focus:outline-none">
          <div className="flex items-center gap-2 p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-[#1F1F23] transition-colors">
            ...
            <div className={`hidden sm:block ${locale === 'ar' ? 'text-right' : 'text-left'}`}>
        ...
        >
          <div className="p-4">
            ...
            <div className="space-y-2">
              <Button variant="outline" className={`w-full ${locale === 'ar' ? 'justify-end' : 'justify-start'}`} size="sm">
                <Settings className="w-4 h-4 mr-2" />
                Profile Settings
              </Button>
              <Button
                variant="outline"
                className={`w-full text-red-600 hover:text-red-700 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 ${locale === 'ar' ? 'justify-end' : 'justify-start'}`}
                size="sm"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="bg-white dark:bg-[#0F0F12] border border-gray-200 dark:border-[#1F1F23] hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">{t('monthly_revenue') || 'Monthly Revenue'}</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
