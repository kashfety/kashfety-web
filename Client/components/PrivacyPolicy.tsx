    ...
    return (
        <>
            <style dangerouslySetInnerHTML={{
                __html: isRTL ? `
                    .privacy-modal-content[dir="rtl"] * {
                        text-align: right !important;
                        direction: rtl !important;
                    }
                    .privacy-modal-content[dir="rtl"] h2,
                    .privacy-modal-content[dir="rtl"] h3,
                    .privacy-modal-content[dir="rtl"] p,
                    .privacy-modal-content[dir="rtl"] ul,
                    .privacy-modal-content[dir="rtl"] li {
                        text-align: right !important;
                    }
                ` : `
                    .privacy-modal-content[dir="ltr"] * {
                        text-align: left !important;
                        direction: ltr !important;
                    }
                    .privacy-modal-content[dir="ltr"] h2,
                    .privacy-modal-content[dir="ltr"] h3,
                    .privacy-modal-content[dir="ltr"] p,
                    .privacy-modal-content[dir="ltr"] ul,
                    .privacy-modal-content[dir="ltr"] li {
                        text-align: left !important;
                    }
                `
            }} />
            <Dialog open={isOpen} onOpenChange={onClose}>
                ...
                >
                    <div
                        className={`w-full privacy-modal-content`}
                        dir={isRTL ? 'rtl' : 'ltr'}
                        style={isRTL ? { direction: 'rtl', textAlign: 'right' } : { direction: 'ltr', textAlign: 'left' }}
                    >
                        <DialogHeader
